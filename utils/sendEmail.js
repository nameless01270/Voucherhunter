    ...
    return `
        ...
        <div>
            <div style="max-width: 620px; margin: 0 auto; font-family: sans-serif; color: #272727;">
                ...
                <p style="color: #272727; text-align: center;">Please Link Below To Reset Password</p>
                <div style="text-align: center;">
                    <a href="${url}" style="font-family: san-serif; 
                    margin: 0 auto; padding: 20px; text-align: center; background: #e63946; border-radius: 5px; font-size: 20px 10px; 
